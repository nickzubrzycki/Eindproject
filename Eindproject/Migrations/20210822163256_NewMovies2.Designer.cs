...
namespace Eindproject.Migrations
{
    ...
    [Migration("20210822163256_NewMovies2")]
    partial class NewMovies2
    {
            ...
            modelBuilder.Entity("Eindproject.Domain.Lijst", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LijstId = 1,
                            BewerktOp = new DateTime(2021, 8, 22, 18, 32, 55, 784, DateTimeKind.Local).AddTicks(3201),
                            ToegeVoegdOp = new DateTime(2021, 8, 22, 18, 32, 55, 775, DateTimeKind.Local).AddTicks(1696)
                        });
                });
